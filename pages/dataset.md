...
| sensorType | array of strings | R | List of sensors with which data were collected in this dataset. See details in the [Sensor object](instrument.md?#sensor-object) |  |
...
| unitsReported | array of strings | R | Unit of measurement reported by the different sensors and instruments used in this dataset. Using controlled vocabulary from a predefined list. | degrees C | [https://github.com/ocean-tracking-network/biologging_standardization/blob/master/templates/fields/unitsReported.md] |
