...
| sensorTypes | array of strings | R | List of sensor types contained in instruments used in this dataset. | Acceleration, Altitude, Temperature, GeolocationByLight | [Biologging standardization](https://github.com/ocean-tracking-network/biologging_standardization/blob/master/templates/fields/sensorType.md) |
...
| isFinalized | boolean | R | Indicates whether the dataset is ongoing or ended. Default value is FALSE. TRUE if dataset has been ended. | FALSE |
...
| url | url | o | A permanent link to the contact person | |
