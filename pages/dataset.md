...
| geographicCoverage | GeographicWENS | R | Spatial information about ata dataset. | (see GeographicWENS object) |
| temporalCoverage| array of DateTime| R | Information about dates or date ranges covered by the resource. Coverages may refer to the times during which the collection or data set was assembled. | (see DateTime object) |
...
| endDate | datetime | R | The end date of the time period within which the observations were collected. NULL when data collection is ongoing. | 2021-12-31T12:00:00Z |
